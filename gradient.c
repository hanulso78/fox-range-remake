...
{
   int cx, cy, x, y, w, h, col, icol, col1, col2, oldpix;
   int r1, r2, b1, b2, g1, g2, rd, gd, bd, r3, g3, b3;
   int r, g, b, ry, rx, ryc, ryb, rxb, rxp, ryp, rr;
   int style, edge, grad, bevel, ilace;
//   int rad, dp;
